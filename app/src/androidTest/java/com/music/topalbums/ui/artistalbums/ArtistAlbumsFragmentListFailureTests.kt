...
class Test1: BasicArtistAlbumsFragmentListFailureTest()
{
    val jsonText:String = "ccccccc" //an unparsable non-json text
    ...
    @Module
    @InstallIn(SingletonComponent::class)
    inner class ArtistAlbumssProvideModule
    {
        @Provides
...
@UninstallModules(BindServiceApiModule::class, InternetConnectionModule::class )
@RunWith(AndroidJUnit4::class)
class Test2: BasicArtistAlbumsFragmentListFailureTest()
{
    val jsonText:String = """
                     {
                        "resultCount": 0,
...
@RunWith(AndroidJUnit4::class)
@UninstallModules(BindServiceApiModule::class, InternetConnectionModule::class )
class Test3: BasicArtistAlbumsFragmentListFailureTest()
{
    val jsonText:String = "cccccc"
...
@HiltAndroidTest
@RunWith(AndroidJUnit4::class)
open class BasicArtistAlbumsFragmentListFailureTest
{
    @get:Rule
